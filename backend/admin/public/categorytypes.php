...
$allTypes = $categorytypes->getAllTypes();
...
<main class="container">
    ...
    <div class="my-3 p-3 rounded shadow-sm section-div">
        <h6 class="border-bottom pb-2 mb-0 fw-bold">TIPU PĀRVALDĪBAS PANELIS</h6>
        <div class="my-3">
            <div class="card-body">
                <button class="btn btn-outline-dark w-100 font-title mb-3" href="#" onclick="location.href='addCategorytype.php'">PIEVIENOT TIPU</button>
                <div id="example1_wrapper" class="dataTables_wrapper dt-bootstrap4 font-default">
                    <table id="example1" class="table table-bordered table-striped dataTable dtr-inline" aria-describedby="example1_info">
                        ...
                        <tbody>
                        <?php
                        foreach($allTypes as $object) {
                            echo "<tr>";
                            echo "<td>" . $object->TypeID . "</td>";
                            echo "<td>" . $object->TypeName . "</td>";
                            echo "<td>";
                            echo "<button class='btn btn-warning me-3' onclick=\"location.href='editCategorytype.php?id=" . $object->TypeID . "'\">Labot</button>";
                            echo "<a class='btn btn-danger' href='" . BACKEND_DIR . "/handlers/deleteHandlers/deleteCategorytype.php?id=" . $object->TypeID . "'\">Dzēst</a>";
                            echo "</td>";
                            echo "</tr>";
                        }
                        ?>
