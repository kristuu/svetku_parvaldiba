...
<main class="container">
    ...
    <div class="my-3 p-3 rounded shadow-sm section-div">
        <h6 class="border-bottom pb-2 mb-0 fw-bold">JAUNA REĢIONA PIEVIENOŠANAS PANELIS</h6>
        <div class="my-3 text-center">
            <form class="w-75 row g-3 mt-3 mx-auto needs-validation" action="<?=BACKEND_DIR?>/handlers/addHandlers/addRegion.php" method="POST" novalidate>
                <div class="col-lg-6">
                    <div class="input-group has-validation">
                        <span class="input-group-text font-title">NOSAUKUMS</span>
                        <input id="RegionName" name="RegionName" minlength="1" maxlength="30" data-bs-toggle="popover" type="text" autocomplete="off" value='' class="form-control font-default" placeholder="Reģiona nosaukums (piem., Sēlija)" required/>
                        <div class="invalid-feedback text-start">
                            Pārliecinies, vai ievadīji nosaukumu pareizi! (min garums 1, max garums 30)
                        </div>
                    </div>
                </div>
                <div class="col-lg-6">
