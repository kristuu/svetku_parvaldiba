...
$dance = $dancesClass->findDance($_GET['id']);
...
<main class="container">
    ...
    <div class="my-3 p-3 rounded shadow-sm section-div">
        <h6 class="border-bottom pb-2 mb-0 fw-bold">DEJAS PĀRVALDĪBAS PANELIS</h6>
        <div class="my-3 text-center">
            <form class="w-75 row g-3 mt-3 mx-auto needs-validation" action="<?=BACKEND_DIR?>/handlers/updateHandlers/updateDance.php" method="POST" novalidate>
                <div class="col-lg-8">
                    <div class="input-group has-validation">
                        <span class="input-group-text font-title">NOSAUKUMS</span>
                        <input hidden name="DanceID" value="<?= $dance->DanceID; ?>"/>
                        <input id="DanceName" name="DanceName" minlength="1" maxlength="255" data-bs-toggle="popover" type="text" autocomplete="off" value='<?= $dance->DanceName; ?>' class="form-control font-default" placeholder="Dejas nosaukums" required/>
