...
$allRehearsals = $rehearsalsClass->getAllRehearsals();
...
<main class="container">
    ...
    <div class="my-3 p-3 rounded shadow-sm section-div">
        ...
        <div class="my-3">
            <div class="card-body">
                <button class="btn btn-outline-dark w-100 font-title mb-3" href="#" onclick="location.href='addRehearsal.php'">PIEVIENOT MĒĢINĀJUMU</button>
                <div id="example1_wrapper" class="dataTables_wrapper dt-bootstrap4 font-default">
                    <table id="example1" class="table table-bordered table-striped dataTable dtr-inline" aria-describedby="example1_info">
                        ...
                        <tbody>
                        <?php
                        if (is_array($allRehearsals)) {
                            foreach($allRehearsals as $object) {
                                echo "<tr>";
                                echo "<td>" . $object->RehearsalID . "</td>";
                                echo "<td>" . $object->RehearsalDesc . "</td>";
                                echo "<td>" . $object->StartTime . "</td>";
                                echo "<td>" . $object->EndTime . "</td>";
                                echo "<td>" . $object->DanceName . "</td>";
                                echo "<td>" . $object->FName . ' ' . $object->LName . "</td>";
                                echo "<td>";
                                echo "<button class='btn btn-warning me-3' onclick=\"location.href='editRehearsal.php?id=" . $object->RehearsalID . "'\">Labot</button>";
                                echo "<a class='btn btn-danger' href='" . BACKEND_DIR . "/handlers/deleteHandlers/deleteRehearsal.php?id=" . $object->RehearsalID . "'\">Dzēst</a>";
                                echo "</td>";
                                echo "</tr>";
                            }
                        }
