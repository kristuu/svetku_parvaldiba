...
<main class="container">
    ...
    <div class="my-3 p-3 rounded shadow-sm section-div">
        <h6 class="border-bottom pb-2 mb-0 fw-bold">JAUNAS KATEGORIJAS PIEVIENOŠANAS PANELIS</h6>
        <div class="my-3 text-center">
            <form class="w-75 row g-3 mt-3 mx-auto needs-validation" action="<?=BACKEND_DIR?>/handlers/addHandlers/addCategory.php" method="POST" novalidate>
                <div class="col-lg-4">
                    <div class="input-group has-validation">
                        <span class="input-group-text font-title">NOSAUKUMS</span>
                        <input id="CategoryName" name="CategoryName" minlength="1" maxlength="10" data-bs-toggle="popover" type="text" autocomplete="off" value='' class="form-control font-default" placeholder="Kategorijas nosaukums (piem., A)" required/>
                    ...
                    <div class="input-group has-validation">
                        ...
                        <select class="form-select font-default" id="CategoryType" name="TypeID">
                            ...
                            foreach ($categorytypesList as $type) {
                                echo "<option class='font-default' value='$type->TypeID'>$type->TypeName</option>";
                            }
                            ?>
                        </select>
                    </div>
