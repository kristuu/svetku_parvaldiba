...
<main class="container">
    ...
    <div class="my-3 p-3 rounded shadow-sm section-div">
        <h6 class="border-bottom pb-2 mb-0 fw-bold">JAUNA MĒĢINĀJUMA PIEVIENOŠANAS PANELIS</h6>
        <div class="my-3 text-center">
            <form class="w-75 row g-3 mt-3 mx-auto needs-validation" action="<?=BACKEND_DIR?>/handlers/addHandlers/addRehearsal.php" method="POST" novalidate>
                <div class="col-lg-12">
                    <div class="input-group has-validation">
                        <span class="input-group-text font-title">APRAKSTS</span>
                        <textarea id="RehearsalDesc" name="RehearsalDesc" minlength="1" maxlength="65535" type="text" autocomplete="off" value='' class="form-control font-default" placeholder="Mēģinājuma apraksts"></textarea>
                ...
                <div class="col-lg-6">
                    <div class="input-group has-validation">
                        ...
                        <input id="StartTime" name="StartTime" type="datetime-local" autocomplete="off" value='' class="form-control font-default" placeholder="Sākuma laiks">
                    </div>
                </div>
                <div class="col-lg-6">
                    <div class="input-group has-validation">
                        <span class="input-group-text font-title">BEIGU LAIKS</span>
                        <input id="EndTime" name="EndTime" type="datetime-local" autocomplete="off" value='' class="form-control font-default" placeholder="Beigu laiks">
                    </div>
                </div>
                <div class="col-lg-6">
                    <div class="input-group has-validation">
                        ...
                        <select class="form-select font-default" id="DanceID" name="DanceID">
                            ...
                            foreach ($allDances as $dance) {
                                echo "<option class='font-default' value='$dance->DanceID'>$dance->DanceName</option>";
                            }
                            ?>
                        </select>
                    </div>
                    ...
                    <div class="input-group has-validation">
                        ...
                        <select class="form-select font-default" id="ChoreographID" name="ChoreographID">
                            ...
                            foreach ($allChoreographs as $choreograph) {
                                echo "<option class='font-default' value='$choreograph->ParticipantID'>$choreograph->FName $choreograph->LName - $choreograph->PersonCode</option>";
                            }
                            ?>
                        </select>
                    </div>
