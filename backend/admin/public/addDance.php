...
<main class="container">
    ...
    <div class="my-3 p-3 rounded shadow-sm section-div">
        <h6 class="border-bottom pb-2 mb-0 fw-bold">JAUNAS DEJAS PIEVIENOŠANAS PANELIS</h6>
        <div class="my-3 text-center">
            <form class="w-75 row g-3 mt-3 mx-auto needs-validation" action="<?=BACKEND_DIR?>/handlers/addHandlers/addDance.php" method="POST" novalidate>
                <div class="col-lg-8">
                    <div class="input-group has-validation">
                        <span class="input-group-text font-title">NOSAUKUMS</span>
                        <input id="DanceName" name="DanceName" minlength="1" maxlength="255" type="text" autocomplete="off" value='' class="form-control font-default" placeholder="Dejas nosaukums" required/>
