...
<main class="container">
    ...
    <div class="my-3 p-3 rounded shadow-sm section-div">
        <h6 class="border-bottom pb-2 mb-0 fw-bold">KOLEKTĪVA PIEVIENOŠANAS PANELIS</h6>
        <div class="my-3 text-center">
            <form class="w-75 row g-3 mt-3 mx-auto needs-validation" enctype="multipart/form-data" action="<?=BACKEND_DIR?>/handlers/addHandlers/addCollective.php" method="POST" novalidate>
                <div class="col-12">
                ...
                <div class="col-lg-8">
                    <div class="input-group has-validation">
                        ...
                        <input id="CollectiveName" name="CollectiveName" minlength="1" maxlength="255" data-bs-toggle="popover" type="text" autocomplete="off" value='' class="form-control font-default" placeholder="TDK «Aura»" required/>
                    ...
                    <div class="input-group has-validation">
                        ...
                        <select class="form-select font-default" id="CategoryID" name="CategoryID">
                            ...
                            foreach ($categories as $object) {
                                echo "<option class='font-default' value='$object->CategoryID'>$object->CategoryName - $object->TypeName</option>";
                            }
                            ?>
                        </select>
                    </div>
                    ...
                    <div class="input-group has-validation">
                        ...
                        <select class="form-select font-default" id="RegionID" name="RegionID">
                            ...
                            foreach ($regions as $object) {
                                echo "<option class='font-default' value='$object->RegionID'>$object->RegionName</option>";
                            }
                            ?>
                        </select>
                    </div>
